...
class LoginViewModel extends StateNotifier<LoginState> {
  ...
  LoginViewModel(this._repository, this._ref, this._storageService) : super(LoginState());
  ...
  Future<void> fetchStudentApplicant(String mobileNumber) async{
    // Save login data when we successfully fetch student data (implies intent to proceed)
         ...
         if (response != null && response.message.status) {
             ...
             final formModel = AdmissionFormModel(
               ...
               applicantDetails: ApplicantDetailsModel(
                 ...
                 schoolTransportRequired: data.schoolTransportRequired?.toLowerCase() == "yes",
               ),
               parentContact: ParentContactModel(
                 ...
                 fathersEducationalQualification: data.fathersEducationalQualification,
                 ...
                 mothersEducationalQualification: data.mothersEducationalQualification,
             ...
             print("LOGIN DEBUG: Setting form data. Transport: ${formModel.applicantDetails?.schoolTransportRequired}");
             print("LOGIN DEBUG: Parent: ${formModel.parentContact?.fathersName}, Guardian: ${formModel.parentContact?.guardiansName}");
